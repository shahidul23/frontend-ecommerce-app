...
const Home = () => {
  return <>
    ...
    <Container class1='feature-wrapper home-wrapper-2 py-4'>
        <div className='row'>
          <div className='col-12'>
    ...
    <Container class1='famous-wrapper home-wrapper-2 py-4'>
      <div className='row'>
        <div className='col-3'>
    ...
    <Container class1='marque-wrapper home-wrapper-2 ho py-4'>
      <div className='row'>
        <div className='col-12'>
