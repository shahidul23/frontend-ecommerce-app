          ...
          <div className='row'>
            ...
            <div className='col-6'>
              <p className='text-end text-white mb-0'>
                Hotline: 
              <a className='text-white' href='tel:+880 1967288486'>+880 1967288486</a></p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className='container-xxl'>
          <div className='row align-items-center'>
            ...
            <div className="input-group">
              <input type="text" className="form-control p-2" placeholder="Search Product Hear..." aria-label="Search Product Hear..." aria-describedby="basic-addon2"/>
          ...
          <div className='row'>
            <div className='col-12'>
              <div className='menu-bottom d-flex align-items-center gap-30'>
                ...
                <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 me-5 gap-20 d-flex align-items-center" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
